...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Users\bpoch\Desktop\Python projects\techproject\src'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Users\bpoch\Desktop\Python projects\techproject\src\Scripts\deactivate.nu'
