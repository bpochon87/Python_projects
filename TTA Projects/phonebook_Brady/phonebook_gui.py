...
# Import other modules so all can work together as single program.
import phonebook_main
import phonebook_func


def load_gui(self):
    # Create Label (a Tkinter class) and their positioning using grid().
    ...
    # Create Entry (a Tkinter class) boxes
    ...
    # Create buttons and their positioning using grid().
    ...
    self.btn_close.grid(row=8, column=4, columnspan=1, padx=(15,10), pady=(45,10), sticky=E)
